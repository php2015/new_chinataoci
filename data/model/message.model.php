    ...
    private function getCondition($condition_array){
        ...
        if($condition_array['no_del_member_id'] != ''){
            if (C('dbdriver') == 'oracle') {
                $condition_sql  .= " and (message.del_member_id is null or (message.del_member_id is not null and message.del_member_id not like '%,{$condition_array['no_del_member_id']},%')) ";                
            } elseif (C('dbdriver') == 'mysqli') {
        ...
        if($condition_array['no_read_member_id'] != ''){
            if (C('dbdriver') == 'oracle') {
                $condition_sql  .= " and (message.read_member_id is null or (message.read_member_id is not null and message.read_member_id not like '%,{$condition_array['no_read_member_id']},%')) ";
            } elseif (C('dbdriver') == 'mysqli') {
