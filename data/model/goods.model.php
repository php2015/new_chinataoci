...
class goodsModel extends Model{
    ...
    public function getGoodsCommendList($store_id, $limit = 5) {
        if (C('dbdriver') == 'mysql') {
            ...
            $goods_id_list = $this->getGoodsOnlineList(array('store_id' => $store_id, 'goods_commend' => 1), 'min(goods_id) as goods_id', 0, 'rand()', $limit,'goods_commonid');
