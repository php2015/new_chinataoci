        ...
        switch ($this->style) {
            case '1':
                ...
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0) {
                    ...
                    $html_page.= '<li><a class="demo" href="' . $this->page_url . ($this->getNowPage() + 1) . '">' . $this->left_inside_a_html . $this->next_page2 . $this->right_inside_a_html . '</a></li>';
                }
                $html_page.= '</ul>';
                break;
            ...
            case '4':
                $html_page.= '<ul>';
                if ($this->getNowPage() <= 1) {
                    $html_page.= '<li>' . $this->left_inside_a_html . $this->pre_page2 . $this->right_inside_a_html . '</li>';
                } else {
                    $html_page.= '<li><a class="demo" href="' . $this->setShopPseudoStaticPageUrl($this->getNowPage() - 1) . '">' . $this->left_inside_a_html . $this->pre_page2 . $this->right_inside_a_html . '</a></li>';
                }
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0) {
                    $html_page.= '<li>' . $this->left_inside_a_html . $this->next_page2 . $this->right_inside_a_html . '</li>';
                } else {
                    $html_page.= '<li><a class="demo" href="' . $this->setShopPseudoStaticPageUrl($this->getNowPage() + 1) . '">' . $this->left_inside_a_html . $this->next_page2 . $this->right_inside_a_html . '</a></li>';
                }
                $html_page.= '</ul>';
                break;
