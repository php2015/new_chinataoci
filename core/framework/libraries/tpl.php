...
class Tpl{
	...
	public static function flexigridXML($flexigridXML){//shopwwi
...
echo $xml;
	...
	public static function flexigridfXML($flexigridXML){//shopwwi
	$page = $flexigridXML['now_page'];
	$total = $flexigridXML['total_num'];
...
echo $xml;		
	...
	public static function flexigridXMLfloor($flexigridXML){//shopwwi
	$page = $flexigridXML['now_page'];
	$total = $flexigridXML['total_num'];
...
echo $xml;		
	...
	public static function flexigroupbuyXML($flexigridXML){//shopwwi
	$page = $flexigridXML['now_page'];
	$total = $flexigridXML['total_num'];
	header("Expires: Mon, 26 Jul 1997 05:00:00 GMT" ); 
header("Last-Modified: " . gmdate( "D, d M Y H:i:s" ) . "GMT" ); 
