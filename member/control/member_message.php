    ...
    public function settingOp() {
        ...
        if (chksubmit()) {
            $insert = array(
                ...
                // 预定订单尾款支付提醒
                array( 'mmt_code' => 'order_book_end_pay', 'member_id' => $_SESSION['member_id'], 'is_receive' => intval($_POST['order_deliver_success']) ),
                // 余额变动提醒
                ...
                // 红包使用提醒
                array( 'mmt_code' => 'rpt_use', 'member_id' => $_SESSION['member_id'], 'is_receive' => intval($_POST['rpt_use']) ),
                // 退款退货提醒
