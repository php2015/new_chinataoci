...
<script type="text/javascript">
    ...
    $("[nc_type='bindbtn']").bind('click',function(){
            ...
            window.open('<?php echo MEMBER_SITE_URL.DS;?>api.php?act=sharebind&type='+data_str.apikey);
            }
    });
    $("#finishbtn").live('click',function(){
            ...
            eval( "data_str = "+data_str);
            //验证是否绑定成功
            var url = '<?php echo urlMember('member_sharemanage');?>&op=checkbind&callback=?';
...
<div class="public-top-layout w">
  <div class="topbar warp-all">
    <div class="user-entry">
      ...
      <?php echo $lang['nc_hello'];?><span><a href="<?php echo urlShop('member', 'home');?>"><?php echo str_cut($_SESSION['member_name'],20);?></a></span><?php echo $lang['nc_comma'],$lang['welcome_to_site'];?> <a href="<?php echo SHOP_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $output['setting_config']['site_name']; ?></span></a> <span>[<a href="<?php echo urlLogin('login','logout');?>"><?php echo $lang['nc_logout'];?></a>]</span>
      <?php }else{?>
  ...
  <div id="navBox">
    ...
    <div class="microMall-user">
      ...
      <ul class="sub-menu">
        ...
        <?php } else { ?>
        <li class="no-sub pngFix"><a href="<?php echo urlLogin('login', 'index', array('ref_url' => getRefUrl()));?>"><?php echo $lang['nc_login'];?></a></li>
        <?php } ?>
