    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <div class="ncs-book-down">
          ...
          <div class="rule-info"><a mxf="sqde" href="javascript:void(0);">预定规则<i class="icon-question-sign"></i>
            <ul>
...
$shownLevelSkus[$sku] = true; ?>
      ...
      <div class="ncs-logistics"><!-- S 物流与运费新布局展示 ByShopWWI网店运维 -->
        ...
        <dl id="ncs-freight" class="ncs-freight">
          ...
          <dd class="ncs-freight_box">
            <div id="ncs-freight-selector" class="ncs-freight-select">
              <div class="text">
                <div><?php if($output['store_info']['deliver_region'] == '|'){echo '请选择地区';}else{echo $output['store_info']['deliver_region'] ? str_replace(' ','',$output['store_info']['deliver_region'][1]) : '请选择地区';}?></div>
                <b>∨</b> </div>
              <div class="content">
      ...
      <div class="ncs-buy">
        ...
        <div class="ncs-point" style="display: none;"><i></i> 
          ...
          <?php } else if ($output['goods']['promotion_type'] == 'groupbuy' && $output['goods']['upper_limit'] > 0){ ?> <!-- 特卖限购 -->
          <span class="look">，每人次限购<strong> 
...
$(function(){
    ...
    <?php if ($output['goods']['is_virtual'] == 1) {?>
    $("#ncStoreMap").load('index.php?act=show_map&op=index&w=420&h=400&store_id=<?php echo $output['goods']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
