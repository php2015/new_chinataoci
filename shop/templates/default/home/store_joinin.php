...
<div class="indextip">
  <div class="container"> <span class="title"><i></i>
    <h3>商家助手</h3>
    </span> <span class="content"><?php echo $output['show_txt'];?></span><span class="titles"><a target="_blank" href="http://pan.baidu.com/s/1gev2mg7"><i></i>
    <h3>点击下载</h3></a>
    </span></div>
</div>
<div class="mains">
<div class="joinin-index-step">
  ...
  <div class="platform_logo">
    <img src="img/platform_logo.png" alt="">
  </div>
...
<?php } ?>
<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/img/index_introduce.js" charset="utf-8"></script>
