  ...
  <div class="ncp-detail">
    ...
    <div class="ncp-gift-summary">
      ...
      <div class="ncp-meta">
        <dl>
          <dt>原&nbsp;&nbsp;&nbsp;&nbsp;价：</dt>
          <dd class="cost-price"><strong><?php echo $lang['currency'].ncPriceFormat($output['prodinfo']['pgoods_price']); ?></strong></dd>
        </dl>
        <dl>
          <dt>所需积分：</dt>
