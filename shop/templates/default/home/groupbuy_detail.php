...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span>
    ...
    <span><a href="<?php echo urlShop('show_groupbuy', 'vr_groupbuy_list'); ?>">虚拟特卖</a></span>
    <?php } else { ?>
    <span><a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list'); ?>">实物特卖</a></span>
    <?php } ?>
    <span class="arrow">></span> <span><?php echo $output['groupbuy_info']['groupbuy_name'];?></span> </div>
</div>
<div class="ncg-container wrapper">
        <div class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?> wrapper">
      ...
      <div class="ncg-group">
        ...
        <h3><?php echo $output['groupbuy_info']['remark'];?></h3></div>
          <div class="button"><span class="sell-price"><?php echo $lang['currency'];?><em><?php echo ncPriceFormat($output['groupbuy_info']['groupbuy_price']);?></em></span><span class="original-price"><?php echo $lang['currency'];?><?php echo ncPriceFormat($output['groupbuy_info']['goods_price']);?></span><span class="discount"><?php echo $output['groupbuy_info']['groupbuy_rebate'];?>折</span><a href="<?php echo $output['groupbuy_info']['goods_url'];?>" target="_blank">我要抢</a></div>
          <div class="info" id="main-nav-holder">
            <div class="prices">
              <dl>
                <dt><?php echo $lang['text_goods_price'];?></dt>
                <dd><del><?php echo $lang['currency'];?><?php echo ncPriceFormat($output['groupbuy_info']['goods_price']);?></del></dd>
              </dl>
              <dl>
        ...
        <div class="floating-bar">
          <div class="button"><span><?php echo $lang['currency'];?><em><?php echo ncPriceFormat($output['groupbuy_info']['groupbuy_price']);?></em></span><a href="<?php echo $output['groupbuy_info']['goods_url'];?>" target="_blank">我要抢</a></div>
          <div class="prices">
            <dl>
              <dt><?php echo $lang['text_goods_price'];?></dt>
              <dd><del><?php echo $lang['currency'];?><?php echo ncPriceFormat($output['groupbuy_info']['goods_price']);?></del></dd>
...
<div class="ncg-layout-l">
    ...
    <!-- S 店铺地址地图 -->
    <div class="ncg-store-map" id="nc-store-map" style="display:none;"></div>
    <!-- E 店铺地址地图 -->
      <?php if ($output['groupbuy_info']['is_vr']) { ?>
      <div class="ncg-instructions">
        ...
        <ul>
          <li> 1. 本次特卖活动的最终有效期至
            ...
            ，兑换码/券的使用期限是
            <time><?php echo date("Y-m-d H:i", $output['goods_info']['virtual_indate']); ?></time>
            ，逾期未使用将被视为自动放弃兑换
            <?php } ?>
            。 </li>
          <li>2. 消费特卖兑换码/券时，请向商家提供系统发送的“虚拟特卖兑换码”，一码一销。</li>
          <?php if ($output['buy_limit'] > 0) { ?>
          <li>3. 单人每笔订单最多特卖<strong><?php echo $output['buy_limit']; ?></strong>个兑换码/券，如需更多请再次购买。</li>
          <?php } ?>
        </ul>
      </div>
      <?php } ?>
      ...
      <div class="ncg-evaluate">
        <div class="top">
          ...
          <div class="btns"><span>您可对已购商品进行评价</span>
            <p><a href="<?php if ($output['groupbuy_info']['is_vr']) { echo urlShop('member_vr_order', 'index');} else { echo urlShop('member_order', 'index');}?>" class="ncbtn ncbtn-grapefruit" target="_blank"><i class="icon-comment-alt"></i>评价商品</a></p>
          </div>
        </div>
        <!-- 商品评价内容部分 -->
      ...
      <div class="content">
        <div class="ncg-group-command">
          ...
          <dl <?php if($hot_groupbuy_count === 1) { echo "style=' border:none'";$hot_groupbuy_count++; }?> >
            ...
            <dd class="item"><a href="<?php echo $hot_groupbuy['groupbuy_url'];?>" target="_blank"><?php echo $lang['to_see'];?></a> <span class="price"><?php echo $lang['currency'].ncPriceFormat($hot_groupbuy['groupbuy_price']);?></span> <span class="buy"><em><?php echo $hot_groupbuy['virtual_quantity']+$hot_groupbuy['buy_quantity'];?></em><?php echo $lang['text_piece'].$lang['text_buy'];?></span> </dd>
          </dl>
          <?php } ?>
          <?php } ?>
        </div>
...
$(function(){
    ...
    <?php if ($output['groupbuy_info']['is_vr']) { ?>
    $("#nc-store-map").load('index.php?act=show_map&op=index&w=420&h=400&store_id=<?php echo $output['groupbuy_info']['store_id'];?>', function(){
        if($(this).html() != '') {
            $(this).show();
        }
    });
