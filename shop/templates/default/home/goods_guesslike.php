...
<style type="text/css">
.goods-guess-like { border: solid 1px #EEE; margin: 0 auto 20px auto; background:#fff;}
...
.goods-promotion {     position: absolute; z-index: 2; top: 15px; left: 15px; height: 42px;}
.goods-promotion span {display: inline-block; float: left; width: 42px;  height: 42px; margin-right: 4px; border-radius: 21px; font-size: 14px; color: #fff; text-align: center;line-height: 42px; background-color: #F3385F;}
