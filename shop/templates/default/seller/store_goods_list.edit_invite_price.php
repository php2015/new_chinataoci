<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?act=store_goods_online&op=edit_invite_price"><!--album_add_save-->
    ...
    <dl>
      ...
      <dd>
        为当前设置的一级佣金的<em style="color:#F00"><?php echo $output['setting_config']['shopwwi_invite2']; ?></em>%
      </dd>
    </dl>
    <dl>
      <dt>三级佣金<?php echo $lang['nc_colon'];?></dt>
      <dd>
        为当前设置的一级佣金的<em style="color:#F00"><?php echo $output['setting_config']['shopwwi_invite3']; ?></em>%
      </dd>
    </dl>
        <dl>
