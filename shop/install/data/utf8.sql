...
(15, 9, '首页通栏', 'a:2:{s:7:"adv_pic";s:21:"04418235791378401.jpg";s:11:"adv_pic_url";s:14:"www.shopwwi.com";}', 1388505600, 1577721600, 0, 0, '', 0, 1, '', 0);
...
(9, '首页底部通栏图片广告', 0, 2, 1, 1200, 80, 1, 0, '04418235791378401.jpg'),
(11, '首页焦点大图广告1', 0, 2, 1, 1920, 481, 0, 0, '11.jpg'),
(12, '首页焦点大图广告2', 0, 2, 1, 1920, 481, 0, 0, '12.jpg'),
(21, '首页焦点联动广告1', 0, 2, 1, 259, 180, 0, 0, '21.jpg'),
(22, '首页焦点联动广告2', 0, 2, 1, 259, 180, 0, 0, '22.jpg'),
(23, '首页焦点联动广告3', 0, 2, 1, 259, 180, 0, 0, '23.jpg'),
(35, '积分列表页中部广告位', 0, 2, 1, 900, 368, 0, 0, '04606336969591517.jpg'),
...
(25, 7, '', 1, 1, 255, '合作及洽谈', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; shopwwi希望与服务代理商、合作伙伴并肩合作，携手开拓日益广阔的网络购物软件市场。如果您拥有好的建议，拥有丰富渠道资源、拥有众多目标客户、拥有相应的市场资源，并希望与shopwwi进行深度业务合作， 欢迎成为shopwwi业务合作伙伴，请联系。</p>\r\n<p>&nbsp;</p>\r\n<p><strong>公司名称</strong>： 网店运维交流中心 <br />\r\n<strong>通信地址</strong>： http://www.shopwwi.com <br />\r\n<strong>邮政编码</strong>： 300121 <br />\r\n<strong>QQ群</strong>： 111731672 <br />\r\n<strong>商务洽谈</strong>： 111731672 <br />\r\n</p>', 1449242303),
...
(35, 1, 'http://www.shopwwi.com/', 1, 1, 1, '火爆销售中', '火爆销售中<br />', 1449242303),
...
CREATE TABLE `#__brand` (
  ...
  `brand_bgpic` VARCHAR( 100 )  DEFAULT '/data/upload/shop/editor/brand_default_max.jpg' NULL COMMENT '品牌大图',
  `brand_xbgpic` VARCHAR( 100 )  DEFAULT '/data/upload/shop/editor/brand_default_small.jpg' NULL COMMENT '品牌小图',
  `brand_tjstore` VARCHAR( 100 )  DEFAULT '请于品牌管理里编辑我' NULL COMMENT '品牌副标题',
  `brand_introduction` VARCHAR( 300 ) DEFAULT '网店运维提醒您：你当前的品牌介绍并没有填写！使用默认的这些会出现在你的眼前，请于后台进行修改' NULL COMMENT '品牌介绍',
...
(99, 4, '合作品牌', '<div class="brand_img">\r\n	<img alt="image" src="http://s.shopwwi.com/data/upload/shop/article/help_store_05090420267966612.png" /> \r\n</div>', '', 1455720125, 1, 1),
...
(2, 'Q群111731672', 'http://www.shopwwi.com', '04639165739281622.jpg', 8),
(39, '交流中心', 'http://www.shopwwi.com', '', 9);
...
(6, 0, '关于ShopWWI', 'member/index.php?act=article&article_id=22', 2, 0, 255, 0),
...
(11, 0, '门户', 'cms', 1, 1, 255, 0),
(12, 0, '圈子', 'circle', 1, 1, 255, 0),
(13, 0, '微商城', 'microshop', 1, 1, 255, 0);
...
CREATE TABLE `#__order_common` (
  ...
  `evalseller_time` int(10) unsigned NULL  COMMENT '卖家评价买家的时间',
...
CREATE TABLE `#__order_goods` (
  ...
  `invite_rates` SMALLINT( 5 )  NULL  DEFAULT '0' COMMENT '分销佣金',
  PRIMARY KEY (`rec_id`),
...
(1, '{sitename} - Powered by shopwwi', 'shopwwi,PHP商城系统,shopwwi商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', 'shopwwi专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index'),
(2, '{sitename} - 团购', 'shopwwi,{sitename}', 'shopwwi专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', 'shopwwi,{name},{sitename}', 'shopwwi,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'brand'),
(5, '{sitename} - {name}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'point'),
(9, '{sitename} - {name}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'article'),
(11, '{sitename} - {name}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', 'shopwwi,{sitename},{key}', 'shopwwi,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', 'shopwwi,{sitename}', 'shopwwi,{sitename}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', 'shopwwi,{sitename},{name}', 'shopwwi,{sitename},{name}', 'sns');
...
INSERT INTO `#__web_channel` (`channel_id`, `channel_name`, `channel_style`, `gc_id`, `gc_name`, `keywords`, `description`, `top_id`, `floor_ids`, `update_time`, `channel_show`) VALUES
