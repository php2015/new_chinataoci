  ...
  <div class="content">
    <div class="scroll switchbox" >
      <ul class="tema">
        <li>
          <h4>源码提供</h4>
          <p>dede168源码网</p>
		  <p>网址：<a href="http://www.dede168.com" target="_blank">www.dede168.com</a></p>
        </li>
      </ul>
    </div>
    <!-- 代码结束 -->
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>版权所有 (c) 2007-2015，网店运维交流中心www.shopwwi.com。
          感谢您选择网店运维S版电商平台系统。希望我们的努力能为您提供一个高效快速和强大的企业级电子商务整体解决方案。</p>
        <p>网店运维S版系统是根据网创系统进化而来！网店运维对本版本不负任何法律责任！网店运维官方网站网址为 <a href="http://www.shopwwi.com" target="_blank">http://www.shopwwi.com</a>。</p>
    ...
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="http://www.shopwwi.com" target="_blank">http://www.shopwwi.com</a></p>
