...
class vr_groupbuyControl extends SystemControl
{
    public function __construct()
    {
        ...
        if (C('groupbuy_allow') != 1) {
            showMessage('虚拟团购功能尚未开启', 'index.php?act=setting', 'html', 'error');
        }
    }
    ...
    public function class_editOp()
    {
        if (chksubmit()) {
            ...
            if ($res) {
                ...
                $this->log('编辑虚拟团购分类[ID:'.intval($_POST['class_id']).']', 1);
    ...
    public function class_delOp()
    {
        ...
        $this->log('删除虚拟团购分类[ID:'.$_POST['class_id'].']', 1);
...
EOB;
    ...
    public function area_editOp()
    {
        if (isset($_POST) && !empty($_POST)) {
            ...
            if ($res) {
                ...
                $this->log('编辑虚拟团购区域[ID:'.intval($_POST['area_id']).']', 1);
    ...
    public function area_dropOp()
    {
        ...
        if ($res) {
            ...
            $this->log('删除虚拟团购区域[ID:'.intval($_POST['area_id']).']',1);
