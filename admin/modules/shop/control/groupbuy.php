...
EOB;
    ...
    public function groupbuy_review_passOp(){
        ...
        if($result) {
            $this->log('通过特卖活动申请，特卖编号'.$groupbuy_id,null);
            // 添加队列
    ...
    public function groupbuy_review_failOp(){
        ...
        if($result) {
            $this->log('拒绝特卖活动申请，特卖编号'.$groupbuy_id,null);
    ...
    public function groupbuy_cancelOp() {
        ...
        if($result) {
            $this->log('取消特卖活动，特卖编号'.$groupbuy_id,null);
    ...
    public function groupbuy_delOp(){
        ...
        if($result) {
            $this->log('删除特卖活动，特卖编号'.$groupbuy_id,null);
    ...
    public function groupbuy_setting_saveOp() {
        ...
        if ($result){
            $this->log('修改特卖套餐价格为'.$groupbuy_price.'元');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'groupbuy_list'=>array('menu_type'=>'link','menu_name'=>'特卖活动','menu_url'=>'index.php?act=groupbuy&op=groupbuy_list'),
