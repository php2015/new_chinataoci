...
<div class="page">
  ...
  <form id="brand_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label>品牌推荐店铺ID</label>
        </dt>
        <dd class="opt">
          <input type="text" value="" name="brand_tjstore" id="brand_tjstore" class="input-txt">
          <span class="err"></span>
          <p class="notic">品牌商品列表页快速导航使用</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <input type="text" value="" name="brand_bgpic" id="brand_bgpic" class="input-txt">
          <span class="err"></span>
          <p class="notic">请填写背景图片完整URL大小为540px*270px</p>
        </dd>
      </dl>
            <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <input type="text" value="" name="brand_xbgpic" id="brand_xbgpic" class="input-txt">
          <span class="err"></span>
      ...
      <dl class="row">
       ...
       <dl class="row">
        ...
        <dd class="opt">
          <?php showEditor('brand_introduction');?>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
